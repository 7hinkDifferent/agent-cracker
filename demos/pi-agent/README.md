...
- [x] **multi-provider-overflow** — 多 Provider Overflow 检测（10+ provider 错误模式匹配 + 静默溢出检测）
- [x] **extension-hooks** — 深度扩展系统（生命周期钩子 + 动态 tool/command 注册 + UI 覆盖）

## 完整串联

- [x] **mini-pi** — 组合以上 MVP 组件的最小完整 agent
